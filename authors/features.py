...
# which book. Reads in the books, processes them, then outputs to
# par_words.csv a list of paragraphs and whether the 300 words with the most 
# gain to split on are present in the corresponding paragraph.
import os
import math
